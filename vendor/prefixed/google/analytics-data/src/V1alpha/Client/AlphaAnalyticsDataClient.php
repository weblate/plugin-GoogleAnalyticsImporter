 ...
 * @experimental
 */
namespace Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Data\V1alpha\Client;
...
final class AlphaAnalyticsDataClient
{
    ...
    {
        return self::getPathTemplate('reportTask')->render(['property' => $property, 'report_task' => $reportTask]);
    }
    /**

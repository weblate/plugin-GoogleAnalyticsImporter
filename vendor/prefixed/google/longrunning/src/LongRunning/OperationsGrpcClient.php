 ...
 */
class OperationsGrpcClient extends \Matomo\Dependencies\GoogleAnalyticsImporter\Grpc\BaseStub
{
    /**
     ...
     */
    public function ListOperations(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\LongRunning\ListOperationsRequest $argument, $metadata = [], $options = [])
    {
        return $this->_simpleRequest('/google.longrunning.Operations/ListOperations', $argument, ['Matomo\\Dependencies\\GoogleAnalyticsImporter\\Google\\LongRunning\\ListOperationsResponse', 'decode'], $metadata, $options);
    }
    /**

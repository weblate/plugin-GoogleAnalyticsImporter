...
class UpdateDataStreamRequest extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
     ...
     *                                                              match all fields.
     *
     * @return \Google\Analytics\Admin\V1beta\UpdateDataStreamRequest
     *
     * @experimental
     */
    public static function build(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1beta\DataStream $dataStream, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\FieldMask $updateMask) : self
    {
        return (new self())->setDataStream($dataStream)->setUpdateMask($updateMask);
    }
    /**
     * Constructor.
     *

...
class CreateFirebaseLinkRequest extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
     ...
     * @experimental
     */
    public static function build(string $parent, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\FirebaseLink $firebaseLink) : self
    {
        return (new self())->setParent($parent)->setFirebaseLink($firebaseLink);
    }
    /**
     * Constructor.
     *

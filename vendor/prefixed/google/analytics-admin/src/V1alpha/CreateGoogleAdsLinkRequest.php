...
class CreateGoogleAdsLinkRequest extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
     ...
     * @experimental
     */
    public static function build(string $parent, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GoogleAdsLink $googleAdsLink) : self
    {
        return (new self())->setParent($parent)->setGoogleAdsLink($googleAdsLink);
    }
    /**
     * Constructor.
     *

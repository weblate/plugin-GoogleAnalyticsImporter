...
class UpdateExpandedDataSetRequest extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
     ...
     * @experimental
     */
    public static function build(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ExpandedDataSet $expandedDataSet, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\FieldMask $updateMask) : self
    {
        return (new self())->setExpandedDataSet($expandedDataSet)->setUpdateMask($updateMask);
    }
    /**
     * Constructor.
     *

...
namespace Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ConversionEvent;
 ...
 * within a session.
 *
 * Protobuf type <code>google.analytics.admin.v1alpha.ConversionEvent.ConversionCountingMethod</code>
 */
class ConversionCountingMethod
{
    ...
    private static $valueToName = [self::CONVERSION_COUNTING_METHOD_UNSPECIFIED => 'CONVERSION_COUNTING_METHOD_UNSPECIFIED', self::ONCE_PER_EVENT => 'ONCE_PER_EVENT', self::ONCE_PER_SESSION => 'ONCE_PER_SESSION'];
...
class_alias(ConversionCountingMethod::class, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ConversionEvent_ConversionCountingMethod::class);

 ...
 */
class CreateAdSenseLinkRequest extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
    /**
     ...
     * @experimental
     */
    public static function build(string $parent, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\AdSenseLink $adsenseLink) : self
    {
        return (new self())->setParent($parent)->setAdsenseLink($adsenseLink);
    }
    /**
     * Constructor.
     *

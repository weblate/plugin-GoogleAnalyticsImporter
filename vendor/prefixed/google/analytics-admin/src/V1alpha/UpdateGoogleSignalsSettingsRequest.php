...
class UpdateGoogleSignalsSettingsRequest extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
     ...
     * @experimental
     */
    public static function build(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\GoogleSignalsSettings $googleSignalsSettings, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\FieldMask $updateMask) : self
    {
        return (new self())->setGoogleSignalsSettings($googleSignalsSettings)->setUpdateMask($updateMask);
    }
    /**
     * Constructor.
     *

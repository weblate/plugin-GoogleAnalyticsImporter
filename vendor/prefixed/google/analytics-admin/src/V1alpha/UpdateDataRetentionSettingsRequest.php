...
class UpdateDataRetentionSettingsRequest extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
     ...
     * @experimental
     */
    public static function build(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\DataRetentionSettings $dataRetentionSettings, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\FieldMask $updateMask) : self
    {
        return (new self())->setDataRetentionSettings($dataRetentionSettings)->setUpdateMask($updateMask);
    }
    /**
     * Constructor.
     *

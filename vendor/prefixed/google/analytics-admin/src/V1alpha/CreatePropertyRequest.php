...
class CreatePropertyRequest extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
     ...
     *                                                           Note: the supplied property must specify its parent.
     *
     * @return \Google\Analytics\Admin\V1alpha\CreatePropertyRequest
     *
     * @experimental
     */
    public static function build(\Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\Property $property) : self
    {

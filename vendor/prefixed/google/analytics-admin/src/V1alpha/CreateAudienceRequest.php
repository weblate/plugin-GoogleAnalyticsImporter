...
class CreateAudienceRequest extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
     ...
     * @experimental
     */
    public static function build(string $parent, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\Audience $audience) : self
    {
        return (new self())->setParent($parent)->setAudience($audience);
    }
    /**
     * Constructor.
     *

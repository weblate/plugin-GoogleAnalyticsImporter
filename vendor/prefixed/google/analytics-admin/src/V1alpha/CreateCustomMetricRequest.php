...
class CreateCustomMetricRequest extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
     ...
     * @experimental
     */
    public static function build(string $parent, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CustomMetric $customMetric) : self
    {
        return (new self())->setParent($parent)->setCustomMetric($customMetric);
    }
    /**
     * Constructor.
     *

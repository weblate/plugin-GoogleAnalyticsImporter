 ...
 */
class CreateCalculatedMetricRequest extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
    /**
     ...
     * @experimental
     */
    public static function build(string $parent, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\CalculatedMetric $calculatedMetric, string $calculatedMetricId) : self
    {
        return (new self())->setParent($parent)->setCalculatedMetric($calculatedMetric)->setCalculatedMetricId($calculatedMetricId);
    }
    /**
     * Constructor.
     *

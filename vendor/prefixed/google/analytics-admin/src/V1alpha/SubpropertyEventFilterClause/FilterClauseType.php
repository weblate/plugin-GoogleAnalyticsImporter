...
namespace Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\SubpropertyEventFilterClause;
...
class FilterClauseType
{
     ...
     */
    const EXCLUDE = 2;
    private static $valueToName = [self::FILTER_CLAUSE_TYPE_UNSPECIFIED => 'FILTER_CLAUSE_TYPE_UNSPECIFIED', self::PBINCLUDE => 'INCLUDE', self::EXCLUDE => 'EXCLUDE'];
...
class_alias(FilterClauseType::class, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\SubpropertyEventFilterClause_FilterClauseType::class);

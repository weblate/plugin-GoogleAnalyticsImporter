...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ConnectedSiteTag;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListAdSenseLinksResponse;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListCalculatedMetricsResponse;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListChannelGroupsRequest;
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListChannelGroupsResponse;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListEventCreateRulesResponse;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListRollupPropertySourceLinksResponse;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListSKAdNetworkConversionValueSchemasResponse;
...
use Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\ListSubpropertyEventFiltersResponse;
...
class AnalyticsAdminServiceGapicClient
{
    ...
    {
        return self::getAdSenseLinkNameTemplate()->render(['property' => $property, 'adsense_link' => $adsenseLink]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getCalculatedMetricNameTemplate()->render(['property' => $property, 'calculated_metric' => $calculatedMetric]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getChannelGroupNameTemplate()->render(['property' => $property, 'channel_group' => $channelGroup]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getDataRedactionSettingsNameTemplate()->render(['property' => $property, 'data_stream' => $dataStream]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getEnhancedMeasurementSettingsNameTemplate()->render(['property' => $property, 'data_stream' => $dataStream]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getEventCreateRuleNameTemplate()->render(['property' => $property, 'data_stream' => $dataStream, 'event_create_rule' => $eventCreateRule]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getRollupPropertySourceLinkNameTemplate()->render(['property' => $property, 'rollup_property_source_link' => $rollupPropertySourceLink]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getSKAdNetworkConversionValueSchemaNameTemplate()->render(['property' => $property, 'data_stream' => $dataStream, 'skadnetwork_conversion_value_schema' => $skadnetworkConversionValueSchema]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent a
    ...
    {
        return self::getSubpropertyEventFilterNameTemplate()->render(['property' => $property, 'sub_property_event_filter' => $subPropertyEventFilter]);
    }
    /**

 ...
 */
class CreateSubpropertyEventFilterRequest extends \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Protobuf\Internal\Message
{
    /**
     ...
     * @experimental
     */
    public static function build(string $parent, \Matomo\Dependencies\GoogleAnalyticsImporter\Google\Analytics\Admin\V1alpha\SubpropertyEventFilter $subpropertyEventFilter) : self
    {
        return (new self())->setParent($parent)->setSubpropertyEventFilter($subpropertyEventFilter);
    }
    /**
     * Constructor.
     *
